...
## set params
airtable_url = "https://api.airtable.com/v0/apphDZ0u4mSBz72NH/Cases/recHGw800QjCMGyog"
airtable_key = "keyEylNiFZt2G6HGa"
url = "{}?api_key={}".format(airtable_url,airtable_key)
dest_file = os.path.join("map2","table-data.json")
